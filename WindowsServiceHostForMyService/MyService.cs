...
namespace WindowsServiceHostForMyService
{
    public partial class MyService : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            service_host = new ServiceHost(typeof(WCFLibrary.MyService), address_base);

            ServiceMetadataBehavior behavior = new ServiceMetadataBehavior();
            service_host.Description.Behaviors.Add(behavior);

            BasicHttpBinding binding_http = new BasicHttpBinding();
            service_host.AddServiceEndpoint(typeof(WCFLibrary.IMyService), binding_http, address_HTTP);
            ...
            service_host.AddServiceEndpoint(typeof(WCFLibrary.IMyService), binding_tcp, address_TCP);
